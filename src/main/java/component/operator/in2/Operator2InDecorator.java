...
/**
 * Base decorator for {@link Operator2In}. Delegates all function calls to the
 * decorated object.
 *
 * @param <IN>
 *            The type of input tuples in the first input stream.
 * @param <IN2>
 *            The type of input tuples in the second input stream.
 * @param <OUT>
...
public class Operator2InDecorator<IN extends Tuple, IN2 extends Tuple, OUT extends Tuple>
	...
	private final ProcessCommand2In<IN, IN2, OUT> processingCommand = new ProcessCommand2In<>(
			this);
	 ...
	 *
	 * @param decorated
	 *            The component.operator to be decorated.
	 */
