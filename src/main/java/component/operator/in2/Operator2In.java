...
public interface Operator2In<IN extends Tuple, IN2 extends Tuple, OUT extends Tuple> extends
  ...
  /**
   * Set the second input {@link SWSRStream} for this component.operator.
   *
   ...
   */
  void addInput2(StreamProducer<IN2> source, SWSRStream<IN2> stream);

  /**
   * Get the second input {@link SWSRStream} for this component.operator.
   *
   * @return The second input stream.
   */
  SWSRStream<IN2> getInput2();
