 ...
 */
class ProcessCommand2In<IN extends Tuple, IN2 extends Tuple, OUT extends Tuple>
  ...
  public final void process() {
    SSSRStream<IN> input1 = component.getInput();
    SSSRStream<IN2> input2 = component.getInput2();
