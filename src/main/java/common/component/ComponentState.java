...
public class ComponentState<IN extends Tuple, OUT extends Tuple> {
	...
	public static enum BoxType {
		OPERATOR {
			@Override
			protected boolean checkState(ComponentState<?, ?> state) {
		...
		protected abstract boolean checkState(ComponentState<?, ?> state);
	}
	...
	public ComponentState(String id, BoxType type, StreamFactory streamFactory) {
		this.id = id;
