...
public class BlockingStream<T extends Tuple> implements SWSRStream<T> {
  ...
  private enum Factory implements StreamFactory {
    ...
    @Override
    public <T extends Tuple> SWSRStream<T> newStream(StreamProducer<T> from, StreamConsumer<T> to,
